...
docker run -p 80:80 -p 81:81 -p 82:82 -v /home/tony/docker-data/swagger/logs:/var/log/nginx -v /home/tony/docker-data/swagger/data:/usr/swagger-data -d --restart always swagger
